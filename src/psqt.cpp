...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S(-11,-3), S(  5, -1), S(  3, 7), S(13, 2) },
   { S(-16,-2), S( -5,  2), S( 19, 6), S(19,-1) },
   { S(-14, 7), S( -9, -4), S( 16,-8), S(20, 2) },
   { S( -5,13), S( -4, 10), S( -5,-1), S( 8,-8) },
   { S(-11,16), S(-12,  6), S( -2, 1), S( 4,16) },
   { S( -2, 1), S( 20,-12), S(-10, 6), S(-2,25) }
  },
  { // Knight
   { S(-165,-105), S(-94,-74), S(-77,-46), S(-79,-18) },
   { S( -77, -70), S(-39,-56), S(-24,-15), S(-11,  6) },
   { S( -62, -38), S(-20,-33), S(  4, -5), S( 17, 27) },
   { S( -28, -36), S(  3,  0), S( 39, 13), S( 45, 34) },
   { S( -29, -41), S( 11,-20), S( 40,  4), S( 48, 35) },
   { S(  -9, -51), S( 28,-38), S( 63,-17), S( 53, 19) },
   { S( -65, -64), S(-21,-45), S(  6,-37), S( 35, 16) },
   { S(-196, -98), S(-78,-89), S(-51,-53), S(-32,-16) }
  },
  { // Bishop
