...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Knight
   { S(-157,-105), S(-88,-74), S(-72,-46), S(-75,-18) },
   { S( -71, -70), S(-35,-56), S(-20,-15), S( -9,  6) },
   { S( -56, -38), S(-16,-33), S(  4, -5), S( 19, 27) },
   { S( -24, -36), S(  5,  0), S( 41, 13), S( 47, 34) },
   { S( -25, -41), S( 13,-20), S( 42,  4), S( 52, 35) },
   { S(  -3, -51), S( 32,-38), S( 63,-17), S( 55, 19) },
   { S( -59, -64), S(-17,-45), S( 10,-37), S( 37, 16) },
   { S(-188, -98), S(-72,-89), S(-45,-53), S(-28,-16) }
  },
  { // Bishop
