...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Knight
   { S(-159,-105), S(-91,-74), S(-75,-46), S(-79,-18) },
   { S( -74, -70), S(-39,-56), S(-24,-15), S(-14,  6) },
   { S( -59, -38), S(-20,-33), S(  4, -5), S( 14, 27) },
   { S( -28, -36), S(  0,  0), S( 36, 13), S( 37, 34) },
   { S( -29, -41), S(  8,-20), S( 37,  4), S( 42, 35) },
   { S(  -6, -51), S( 28,-38), S( 63,-17), S( 50, 19) },
   { S( -62, -64), S(-21,-45), S(  6,-37), S( 32, 16) },
   { S(-190, -98), S(-75,-89), S(-48,-53), S(-32,-16) }
  },
  { // Bishop
