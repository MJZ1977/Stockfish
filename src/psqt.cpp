...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // King
   { S(272,  2), S(325, 43), S(273, 80), S(190, 93) },
   { S(277, 59), S(305,100), S(241,138), S(183,131) },
   { S(198, 88), S(253,140), S(168,165), S(120,173) },
   { S(169,105), S(191,154), S(136,168), S(108,169) },
   { S(145,100), S(176,168), S(112,197), S( 69,194) },
   { S(122, 89), S(159,166), S( 85,174), S( 36,189) },
   { S( 87, 42), S(120,100), S( 64,128), S( 25,141) },
   { S( 64,  7), S( 87, 62), S( 49, 75), S(  0, 75) }
  }
};
