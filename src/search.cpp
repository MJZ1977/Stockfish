...
namespace {
  ...
  Value search(Position& pos, Stack* ss, Value alpha, Value beta, Depth depth, bool cutNode) {
    ...
    if (!rootNode && TB::Cardinality)
    {
            ...
            && !pos.can_castle(ANY_CASTLING))
        {
            ...
            if (err != TB::ProbeState::FAIL)
            {
                ...
                {
                    tte->save(posKey, value_to_tt(value, ss->ply), ss->pvHit, b,
    ...
    else
    {
        ...
        tte->save(posKey, VALUE_NONE, ss->pvHit, BOUND_NONE, DEPTH_NONE, MOVE_NONE, pureStaticEval);
    }
...
moves_loop: // When in check, search starts from here
    ...
    */
    ...
    if (!excludedMove)
        tte->save(posKey, value_to_tt(bestValue, ss->ply), ss->pvHit,
  ...
  Value qsearch(Position& pos, Stack* ss, Value alpha, Value beta, Depth depth) {
    ...
    else
    {
        ...
        {
            if (!ttHit)
                tte->save(posKey, value_to_tt(bestValue, ss->ply), ss->pvHit, BOUND_LOWER,
