...
namespace {
  ...
  constexpr double MaxRatio   = 8.0;  // When in trouble, we can step over reserved time with this ratio
  constexpr double StealRatio = 0.37; // However we must not steal time from remaining moves over this ratio
